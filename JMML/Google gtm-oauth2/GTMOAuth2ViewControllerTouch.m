...
- (void)viewDidLoad {
  ...
  // CTCT override "back" button with "cancel"
  leftBarButtonItem_ = [[UIBarButtonItem alloc] initWithTitle:@"Cancel" style:UIBarButtonItemStyleDone target:self action:@selector(cancelClicked)];
